...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_7__.mapGetters)(['config'])),
  data: function data() {
    return {
      password: '',
      isLoading: false
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                axios__WEBPACK_IMPORTED_MODULE_5___default().post('/api/sharing/authenticate/' + _this.$route.params.token, {
                  ...
                  if (error.response.status === 401) _this.$refs.authenticateProtected.setErrors({
