...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    resendEmail: function resendEmail() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_7___default().post('/api/user/verify', {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                axios__WEBPACK_IMPORTED_MODULE_7___default().post('/api/user/check', {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 13:
                ...
                axios__WEBPACK_IMPORTED_MODULE_7___default().post('/login', {
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                if (!recovery && _this4.twoFactorCode.length === 6 || recovery && _this4.twoFactorRecoveryCode.length === 21) {
                  ...
                  axios__WEBPACK_IMPORTED_MODULE_7___default().post('/two-factor-challenge', payload).then(function () {
