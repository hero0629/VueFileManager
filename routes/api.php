...
use App\SubCategories\Controllers\SubCategoryController;
...
use Domain\Folders\Controllers\CreateFolderCustomController;
use Domain\Browsing\Controllers\BrowseFolderController;
use Domain\Browsing\Controllers\BrowseAllFolderController;
...
use Domain\Browsing\Controllers\FilterSearchController;
...
// catagory
Route::get('/admin/documents', [DocumentController::class, 'show']);
Route::apiResource('/admin/documents', DocumentController::class);
Route::get('/admin/sub-category/{id}', [SubCategoryController::class,'getSubacategories']);
Route::apiResource('/admin/sub-categories', SubCategoryController::class);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::group(['prefix' => 'browse'], function () {
        ...
        Route::get('/all-folders/{id}', BrowseAllFolderController::class);
    ...
    // get all users
    Route::get('/users', [FilterSearchController::class, 'getUsers']);
    // Filter
    Route::get('/filter', FilterSearchController::class);
});
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('/create-folder-custom', CreateFolderCustomController::class);
