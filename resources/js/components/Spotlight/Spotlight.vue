    ...
    methods: {
        ...
        findResult: debounce(function (value) {
            ...
            if (this.$route.name == "AllFiles") {
                requestParams = { query: value, page: 'AllFiles' }
                console.log("This page is AllFiles")
            } else {
                requestParams = { query: value, page: "Files" }
            }
            ...
            axios
                ...
                .then((response) => {
                    ...
                    console.log("get search result", this.results)
                })
