const routesAdmin = [
    {
        ...
        children: [
...

            {
                ...
                component: () => import(/* webpackChunkName: "chunks/Documents" */ '../views/Admin/Documents'),
                meta: {
                    requiresAuth: true,
            ...
            },
            {
                ...
                component: () => import(/* webpackChunkName: "chunks/document" */ '../views/Admin/Documents/Document'),
                meta: {
                    requiresAuth: true,
                ...
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "chunks/document-delete" */ '../views/Admin/Documents/DocumentTabs/DocumentDelete'
                                ),
                        meta: {
                            requiresAuth: true,
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "chunks/document-detail" */ '../views/Admin/Documents/DocumentTabs/DocumentDetail'
                                ),
                        meta: {
                            requiresAuth: true,
                            title: 'detail',
            ...
            },
            {
                ...
                component: () => import(/* webpackChunkName: "chunks/document-create" */ '../views/Admin/Documents/DocumentsCreate'),
                meta: {
                    requiresAuth: true,
...

            {
                ...
                component: () => import(/* webpackChunkName: "chunks/SubCategories" */ '../views/Admin/SubCategories'),
                meta: {
                    requiresAuth: true,
                    title: 'routes_title.subcategories_list',
                },
            ...
            {
                path: '/admin/subcategories/:id',
                component: () => import(/* webpackChunkName: "chunks/document" */ '../views/Admin/SubCategories/SubCategory'),
                meta: {
                    requiresAuth: true,
                    title: 'routes_title.subcategories_subcategory',
                },
                children: [

                    {
                        name: 'SubCategoryDetail',
                        path: '/admin/subcategories/:id/details',
                        component: () =>
                            import(
                                /* webpackChunkName: "chunks/document-detail" */ '../views/Admin/SubCategories/SubCategoriesTabs/SubCategoryDetail'
                                ),
                        meta: {
                            requiresAuth: true,
                            title: 'detail',
...

            {
                ...
                path: '/admin/subcategory/:id/create',
                component: () =>
                    import(
                        /* webpackChunkName: "chunks/document-detail" */ '../views/Admin/SubCategories/SubCategoryCreate'
                        ),
                meta: {
                    requiresAuth: true,
                    title: 'create',
